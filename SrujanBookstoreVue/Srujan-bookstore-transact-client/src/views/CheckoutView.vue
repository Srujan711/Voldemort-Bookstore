...
import type {Order, OrderDetails, ServerErrorResponse} from "@/types";
  ...
  <div class="checkout-page">
    ...
    <template v-if="cart.empty">
      <div class="empty-cart-message">
        <h1>Your cart is empty. Please add items before checking out.</h1> <br>
        <router-link :to="{ name: 'category-view' }">
          <button class="button cont-shopping-button"><i class="fas fa-arrow-left"></i>Continue Shopping</button>
        </router-link>
      </div>
    </template>
